...
java_build_graph_dir = os.path.join(os.getcwd(), '../java')
sys.path.append(java_build_graph_dir)
from build_java_graph import *
RAW_FILE = os.path.join(home_path, 'data/code_search_data/CodeSearchNet/resources/tests/data/python/python.jsonl.gz')
